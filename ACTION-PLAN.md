...
2. **12 orphan page(s) with zero inbound internal links.**
   - Priority: `Critical`
   - Area: `link_profile`
...
7. **13 page(s) with no outbound internal links (dead ends).**
   - Priority: `Warning`
   - Area: `link_profile`
   - Evidence: See audit output.
   - Fix: Add contextual internal links to related content from these pages.
8. **No Wikidata entry found for 'Aarogyatra Global Care'.**
   - Priority: `Info`
   - Area: `Wikidata`
   - Evidence: See audit output.
...
9. **No Wikipedia article found for 'Aarogyatra Global Care'.**
   - Priority: `Info`
   - Area: `Wikipedia`
   - Evidence: See audit output.
