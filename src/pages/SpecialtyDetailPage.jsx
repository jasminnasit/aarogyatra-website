  ...
  return (
    <div className="space-y-12 pb-16">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-slate-900 text-white rounded-3xl p-8 sm:p-12 shadow-2xl relative overflow-hidden grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-4 flex flex-col gap-3">
            ...
            <a
              href={`https://wa.me/919900000000?text=Hello%20Aarogyatra,%20I%20have%20a%20question%20regarding%20${encodeURIComponent(treatment.title)}.`}
              target="_blank"
              rel="noreferrer"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl p-8 border border-slate-200/80 shadow-xl space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <span className="text-xs font-bold uppercase tracking-wider text-teal-600">Cost Transparency</span>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-900 text-white text-xs uppercase tracking-wider">
                  <th className="p-4 rounded-tl-xl">Procedure</th>
                  <th className="p-4 bg-teal-800 text-teal-100 font-bold">Gujarat Cost Range</th>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 text-xs text-amber-900 flex items-start gap-2.5">
            ...
            <div>
              <strong>Note:</strong> Final written estimate depends on implant choice, surgical complexity, and pre-existing medical conditions. You receive a complete written, all-inclusive quote before travelling.
            </div>
          </div>
        </div>
      </section>

      {/* 3 & 4. WHAT'S INCLUDED & TYPICAL STAY */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-8">
        
        <div className="lg:col-span-7 bg-white rounded-3xl p-8 border border-slate-200/80 shadow-lg space-y-4">
          <h3 className="text-xl font-bold text-slate-900 font-outfit">
        ...
        {/* 5. RECOVERY & 8-WEEK AFTERCARE */}
        <div className="lg:col-span-5 bg-gradient-to-br from-teal-900 to-slate-900 text-white rounded-3xl p-8 shadow-xl space-y-4 flex flex-col justify-between">
          ...
          <div className="pt-4 border-t border-teal-800/80">
            ...
            >
              Request Doctor Opinion For My Reports
            </button>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-slate-100 rounded-3xl p-8 text-center space-y-4 border border-slate-200">
          <h3 className="text-2xl font-bold text-slate-900 font-outfit">
            Ready to review your treatment plan with our doctors?
          </h3>
          <p className="text-slate-600 text-sm max-w-xl mx-auto">
            Upload your medical reports for a free physician opinion within 48 hours. Zero obligation to travel.
          </p>
          <div className="flex justify-center gap-4">
            <button
              onClick={() => { setActivePage('free-opinion'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
              className="px-8 py-3.5 bg-teal-600 hover:bg-teal-700 text-white font-bold text-sm rounded-xl shadow-md transition-all"
            >
